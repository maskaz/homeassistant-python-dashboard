...
from qtpy.QtGui import QColor, QFont, QPainter, QFontMetrics, QPen, QBrush
...
class Slider(QWidget):
    ...
    def __init__(self, parent=None):
     ...
     #   self.setAttribute(Qt.WA_OpaquePaintEvent)
        ...
        self._value_text_pos = "bottom_left"   # lub: "custom"
        self._value_text_offset = (5, -7)      # (x, y) względem rogu
    # ------------------------------------------------------------
    # Gradient helpers
    # ------------------------------------------------------------
    ...
    def _value_color(self):
        """MIN = lighter version, MAX = original accent color."""
    ...
    def paintEvent(self, event):
        ...
        # Oblicz dynamiczne zaokrąglenie w zależności od wysokości
    ...
    # Kwantyzacja wartości do kroku
        if self._single_step:
            step = self._single_step
            # zaokrąglamy do najbliższego kroku względem minimum
